...
public class TestUtil {
  ...
  public static BeregnForskuddGrunnlag byggForskuddGrunnlag(String beregnDatoFra, String beregnDatoTil) {
    ...
    bmBarnListe.add(new BarnIHusstandenPeriode(BARN_I_HUSSTANDEN_REFERANSE_1, new Periode(LocalDate.parse("2017-01-01"), LocalDate.parse("2018-06-17")), 2d));
    bmBarnListe.add(new BarnIHusstandenPeriode(BARN_I_HUSSTANDEN_REFERANSE_2, new Periode(LocalDate.parse("2018-06-17"), LocalDate.parse("2019-03-31")), 1d));
    bmBarnListe.add(new BarnIHusstandenPeriode(BARN_I_HUSSTANDEN_REFERANSE_3, new Periode(LocalDate.parse("2019-03-31"), null), 2d));
  ...
  public static BeregnForskuddGrunnlag byggForskuddGrunnlagMedJusteringAvInntekter() {
    ...
    var bmBarnListe = singletonList(new BarnIHusstandenPeriode(
        BARN_I_HUSSTANDEN_REFERANSE_1, new Periode(LocalDate.parse("2018-01-01"), null), 1d));
