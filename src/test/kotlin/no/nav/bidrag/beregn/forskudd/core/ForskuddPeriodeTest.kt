...
internal class ForskuddPeriodeTest {
    ...
    fun testUtvidetGrunnlag() {
        ...
        assertAll(
            ...
            Executable { assertThat(resultat.beregnetForskuddPeriodeListe[0].resultat.kode).isEqualTo(ResultatKodeForskudd.FORHOYET_FORSKUDD_100_PROSENT) },
            ...
            Executable { assertThat(resultat.beregnetForskuddPeriodeListe[2].resultat.kode).isEqualTo(ResultatKodeForskudd.ORDINAERT_FORSKUDD_75_PROSENT) },
            ...
            Executable { assertThat(resultat.beregnetForskuddPeriodeListe[3].resultat.kode).isEqualTo(ResultatKodeForskudd.ORDINAERT_FORSKUDD_75_PROSENT) },
            ...
            Executable { assertThat(resultat.beregnetForskuddPeriodeListe[4].resultat.kode).isEqualTo(ResultatKodeForskudd.ORDINAERT_FORSKUDD_75_PROSENT) },
            ...
            Executable { assertThat(resultat.beregnetForskuddPeriodeListe[6].resultat.kode).isEqualTo(ResultatKodeForskudd.ORDINAERT_FORSKUDD_75_PROSENT) },
            ...
            Executable { assertThat(resultat.beregnetForskuddPeriodeListe[7].resultat.kode).isEqualTo(ResultatKodeForskudd.REDUSERT_FORSKUDD_50_PROSENT) },
            ...
            Executable { assertThat(resultat.beregnetForskuddPeriodeListe[8].resultat.kode).isEqualTo(ResultatKodeForskudd.ORDINAERT_FORSKUDD_75_PROSENT) },
    ...
    private fun printGrunnlagResultat(resultat: BeregnForskuddResultat) {
        resultat.beregnetForskuddPeriodeListe
            ...
            .forEach {
                println(
                    "Dato fom: ${it.periode.datoFom}; Dato til: ${it.periode.datoTil}; Beløp: ${it.resultat.belop.toInt()}; Resultatkode: ${it.resultat.kode}; Regel: ${it.resultat.regel}"
                )
            }
    }
